...
export default function ReportDetail() {
  ...
  // might need to add loading states for different sections
  ...
  const updateStatus = async () => {
    ...
    try {
      ...
      // should probably show toast notification or something
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-6xl">
      <div className="mb-6">
        ...
        <h1 className="text-3xl font-bold text-gray-900">Report {report.publicId}</h1>
      </div>
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  {report.location.details && (
                    <div className="flex items-start gap-2 text-sm ml-6">
                      ...
                      <span className="text-gray-600">{report.location.details}</span>
                    </div>
                  )}
            ...
            {report.attachments.length > 0 && (
              <Card>
                <CardHeader>
                  <CardTitle>Evidence & Attachemnts</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
